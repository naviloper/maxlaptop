...
abstract class BaseModel extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the weigth field.
	...
	/**
	 * Set the value of [weigth] column.
	 * 
	...
	public function setWeight($v)
	{
		...
		if ($this->weigth !== $v || $this->isNew()) {
			$this->weigth = $v;
			$this->modifiedColumns[] = ModelPeer::WEIGTH;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->weigth = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ModelPeer::WEIGTH)) $criteria->add(ModelPeer::WEIGTH, $this->weigth);
