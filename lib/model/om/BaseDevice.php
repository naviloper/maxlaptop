...
abstract class BaseDevice extends BaseObject  implements Persistent {
	...
	public function setTypeId($v)
	{
		...
		if ($this->aDeviceType !== null && $this->aDeviceType->getId() !== $v) {
	...
	public function setInfo($v)
	{
		...
		if ($this->info !== $v) {
			$this->info = $v;
			$this->modifiedColumns[] = DevicePeer::INFO;
		}
	...
	public function setRating($v)
	{
		...
		if ($this->rating !== $v) {
			$this->rating = $v;
			$this->modifiedColumns[] = DevicePeer::RATING;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = DevicePeer::NUM_COLUMNS - DevicePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->aDeviceType !== null && $this->type_id !== $this->aDeviceType->getId()) {
			$this->aDeviceType = null;
		}
	} // ensureConsistency
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseDevice:delete:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseDevice:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseDevice:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseDevice:save:post') as $callable)
				{
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DevicePeer::INFO)) $criteria->add(DevicePeer::INFO, $this->info);
		if ($this->isColumnModified(DevicePeer::RATING)) $criteria->add(DevicePeer::RATING, $this->rating);
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseDevice:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseDevice::%s', $method));
	  }
