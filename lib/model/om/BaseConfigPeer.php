...
abstract class BaseConfigPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ModelId', 'ConfigName', 'Weight', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'modelId', 'configName', 'weight', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::MODEL_ID, self::CONFIG_NAME, self::WEIGTH, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'model_id', 'config_name', 'weigth', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ModelId' => 1, 'ConfigName' => 2, 'Weight' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'modelId' => 1, 'configName' => 2, 'weight' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::MODEL_ID => 1, self::CONFIG_NAME => 2, self::WEIGTH => 3, self::CREATED_AT => 4, self::UPDATED_AT => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'model_id' => 1, 'config_name' => 2, 'weigth' => 3, 'created_at' => 4, 'updated_at' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ConfigPeer::MODEL_ID);
		$criteria->addSelectColumn(ConfigPeer::CONFIG_NAME);
		$criteria->addSelectColumn(ConfigPeer::WEIGTH);
	...
	public static function doCountJoinModel(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ConfigPeer::MODEL_ID, ModelPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Config objects pre-filled with their Model objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinModel(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ConfigPeer::addSelectColumns($criteria);
		$startcol = (ConfigPeer::NUM_COLUMNS - ConfigPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Config) to $obj2 (Model)
				$obj2->addConfig($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ConfigPeer::addSelectColumns($criteria);
		$startcol2 = (ConfigPeer::NUM_COLUMNS - ConfigPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Config) to the collection in $obj2 (Model)
				$obj2->addConfig($obj1);
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += ConfigPeer::doOnDeleteCascade(new Criteria(ConfigPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += ConfigPeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = ConfigPeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {
			...
			$criteria->add(FieldValuePeer::CONFIG_ID, $obj->getId());
