...
class sfGuardUserTableMap extends TableMap {
	...
	{
    $this->addRelation('Ads', 'Ads', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('LogsRelatedByQueryBy', 'Logs', RelationMap::ONE_TO_MANY, array('id' => 'query_by', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('LogsRelatedByCheckBy', 'Logs', RelationMap::ONE_TO_MANY, array('id' => 'check_by', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('Review', 'Review', RelationMap::ONE_TO_MANY, array('id' => 'author_id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('Score', 'Score', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('Shop', 'Shop', RelationMap::ONE_TO_MANY, array('id' => 'owner_id', ), 'RESTRICT', 'RESTRICT');
    $this->addRelation('UserMeta', 'UserMeta', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), 'RESTRICT', 'RESTRICT');
