...
abstract class BaseLink extends BaseObject  implements Persistent {
	...
	public function setValue($v)
	{
		...
		if ($this->value !== $v) {
			$this->value = $v;
			$this->modifiedColumns[] = LinkPeer::VALUE;
		}
	...
	public function setHref($v)
	{
		...
		if ($this->href !== $v) {
			$this->href = $v;
			$this->modifiedColumns[] = LinkPeer::HREF;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->href = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LinkPeer::VALUE)) $criteria->add(LinkPeer::VALUE, $this->value);
		if ($this->isColumnModified(LinkPeer::TITLE)) $criteria->add(LinkPeer::TITLE, $this->title);
		if ($this->isColumnModified(LinkPeer::HREF)) $criteria->add(LinkPeer::HREF, $this->href);
