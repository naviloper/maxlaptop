...
class PostCategoryTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.map.PostCategoryTableMap';
	...
	{
    $this->addRelation('PostCategoryRelation', 'PostCategoryRelation', RelationMap::ONE_TO_MANY, array('id' => 'category_id', ), 'RESTRICT', 'RESTRICT');
	} // buildRelations()
