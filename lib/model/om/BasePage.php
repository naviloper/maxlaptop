...
abstract class BasePage extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the p_order field.
	...
	public function setMetadata($v)
	{
		...
		if ($this->metadata !== $v) {
			$this->metadata = $v;
			$this->modifiedColumns[] = PagePeer::METADATA;
		}
	...
	/**
	 * Set the value of [p_order] column.
	 * 
	 * @param      string $v new value
	 * @return     Page The current object (for fluent API support)
	 */
	public function setPOrder($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->p_order !== $v || $this->isNew()) {
			$this->p_order = $v;
			$this->modifiedColumns[] = PagePeer::P_ORDER;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->keywords = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->metadata = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->content = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->is_published = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			$this->p_order = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PagePeer::METADATA)) $criteria->add(PagePeer::METADATA, $this->metadata);
		...
		if ($this->isColumnModified(PagePeer::P_ORDER)) $criteria->add(PagePeer::P_ORDER, $this->p_order);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setPOrder($this->p_order);
	...
	{
		if ($this->aPageRelatedByParentId === null && (($this->parent_id !== "" && $this->parent_id !== null))) {
			$this->aPageRelatedByParentId = PagePeer::retrieveByPk($this->parent_id);
	...
	public function countPagesRelatedByParentId(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collPagesRelatedByParentId === null) {
			if ($this->isNew()) {
				...
				$count = PagePeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
