...
abstract class BaseDevicePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'TypeId', 'Name', 'Info', 'Rating', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'typeId', 'name', 'info', 'rating', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TYPE_ID, self::NAME, self::INFO, self::RATING, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'type_id', 'name', 'info', 'rating', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'TypeId' => 1, 'Name' => 2, 'Info' => 3, 'Rating' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'typeId' => 1, 'name' => 2, 'info' => 3, 'rating' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TYPE_ID => 1, self::NAME => 2, self::INFO => 3, self::RATING => 4, self::CREATED_AT => 5, self::UPDATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'type_id' => 1, 'name' => 2, 'info' => 3, 'rating' => 4, 'created_at' => 5, 'updated_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(DevicePeer::INFO);
		$criteria->addSelectColumn(DevicePeer::RATING);
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseDevicePeer', $criteria, $con);
		}
	 ...
	 *
	 * @param      Device $value A Device object.
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = DevicePeer::getOMClass(false);
	...
	public static function doCountJoinDeviceType(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(DevicePeer::TYPE_ID, DeviceTypePeer::ID, $join_behavior);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		DeviceTypePeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (DeviceTypePeer::NUM_COLUMNS - DeviceTypePeer::NUM_LAZY_LOAD_COLUMNS);
	...
	{
		return $withPrefix ? DevicePeer::CLASS_DEFAULT : DevicePeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Device or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseDevicePeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseDevicePeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseDevicePeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseDevicePeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a Device or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseDevicePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseDevicePeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseDevicePeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseDevicePeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the device table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Device or Criteria object OR a primary key value.
	 *
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseDevicePeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
