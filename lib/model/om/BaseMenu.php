...
abstract class BaseMenu extends BaseObject  implements Persistent {
	...
	public function setSlot($v)
	{
		...
		if ($this->slot !== $v) {
			$this->slot = $v;
			$this->modifiedColumns[] = MenuPeer::SLOT;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MenuPeer::SLOT)) $criteria->add(MenuPeer::SLOT, $this->slot);
	...
	/**
	 * Gets an array of MenuItem objects which contain a foreign key that references this object.
	 *
		...
		if ($this->collMenuItems === null) {
			if ($this->isNew()) {
			   $this->collMenuItems = array();
				...
				$criteria->add(MenuItemPeer::MENU_ID, $this->id);
	...
	public function countMenuItems(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collMenuItems === null) {
			if ($this->isNew()) {
				...
				$count = MenuItemPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
