...
abstract class BaseConfig extends BaseObject  implements Persistent {
	...
	public function setModelId($v)
	{
		...
		if ($this->model_id !== $v) {
			$this->model_id = $v;
			$this->modifiedColumns[] = ConfigPeer::MODEL_ID;
		}
	...
	public function setWeight($v)
	{
		...
		if ($this->weigth !== $v || $this->isNew()) {
			$this->weigth = $v;
			$this->modifiedColumns[] = ConfigPeer::WEIGTH;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->config_name = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->weigth = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			...
			return $startcol + 6; // 6 = ConfigPeer::NUM_COLUMNS - ConfigPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setConfigName($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ConfigPeer::MODEL_ID)) $criteria->add(ConfigPeer::MODEL_ID, $this->model_id);
		if ($this->isColumnModified(ConfigPeer::CONFIG_NAME)) $criteria->add(ConfigPeer::CONFIG_NAME, $this->config_name);
		if ($this->isColumnModified(ConfigPeer::WEIGTH)) $criteria->add(ConfigPeer::WEIGTH, $this->weigth);
	 ...
	 * Otherwise if this Config has previously been saved, it will retrieve
	 * related Adss from storage. If this Config is new, it will return
		...
		if ($this->collAdss === null) {
			if ($this->isNew()) {
			   $this->collAdss = array();
				...
				$criteria->add(AdsPeer::CONFIG_ID, $this->id);
	 ...
	 * Otherwise if this Config is new, it will return
	 * an empty collection; or if this Config has previously
	 * been saved, it will retrieve related Adss from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Config.
	 */
	public function getAdssJoinsfGuardUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ConfigPeer::DATABASE_NAME);
		}
		...
		if ($this->collAdss === null) {
			if ($this->isNew()) {
				...
				$this->collAdss = AdsPeer::doSelectJoinsfGuardUser($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Config has previously been saved, it will retrieve
	 * related FieldValues from storage. If this Config is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collFieldValues === null) {
			if ($this->isNew()) {
			   $this->collFieldValues = array();
				...
				$criteria->add(FieldValuePeer::CONFIG_ID, $this->id);
	 ...
	 * actually need in Config.
	 */
	public function getFieldValuesJoinConfigField($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ConfigPeer::DATABASE_NAME);
		}
		...
		if ($this->collFieldValues === null) {
			if ($this->isNew()) {
				...
				$this->collFieldValues = FieldValuePeer::doSelectJoinConfigField($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Config has previously been saved, it will retrieve
	 * related ShopVitrins from storage. If this Config is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collShopVitrins === null) {
			if ($this->isNew()) {
			   $this->collShopVitrins = array();
				...
				$criteria->add(ShopVitrinPeer::CONFIG_ID, $this->id);
	 ...
	 * actually need in Config.
	 */
	public function getShopVitrinsJoinShop($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ConfigPeer::DATABASE_NAME);
		}
		...
		if ($this->collShopVitrins === null) {
			if ($this->isNew()) {
				...
				$this->collShopVitrins = ShopVitrinPeer::doSelectJoinShop($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
