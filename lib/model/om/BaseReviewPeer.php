...
abstract class BaseReviewPeer {
	...
	const MODEL_ID = 'review.MODEL_ID';

	/** the column name for the CONS field */
	const CONS = 'review.CONS';

	/** the column name for the PROS field */
	const PROS = 'review.PROS';

	/** the column name for the RTEXT field */
	const RTEXT = 'review.RTEXT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'AuthorId', 'ModelId', 'Cons', 'Pros', 'Rtext', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'authorId', 'modelId', 'cons', 'pros', 'rtext', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::AUTHOR_ID, self::MODEL_ID, self::CONS, self::PROS, self::RTEXT, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'author_id', 'model_id', 'cons', 'pros', 'rtext', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'AuthorId' => 1, 'ModelId' => 2, 'Cons' => 3, 'Pros' => 4, 'Rtext' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'authorId' => 1, 'modelId' => 2, 'cons' => 3, 'pros' => 4, 'rtext' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::AUTHOR_ID => 1, self::MODEL_ID => 2, self::CONS => 3, self::PROS => 4, self::RTEXT => 5, self::CREATED_AT => 6, self::UPDATED_AT => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'author_id' => 1, 'model_id' => 2, 'cons' => 3, 'pros' => 4, 'rtext' => 5, 'created_at' => 6, 'updated_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ReviewPeer::AUTHOR_ID);
		$criteria->addSelectColumn(ReviewPeer::MODEL_ID);
		$criteria->addSelectColumn(ReviewPeer::CONS);
		$criteria->addSelectColumn(ReviewPeer::PROS);
		$criteria->addSelectColumn(ReviewPeer::RTEXT);
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseReviewPeer', $criteria, $con);
		}
	...
	public static function doCountJoinsfGuardUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ReviewPeer::AUTHOR_ID, sfGuardUserPeer::ID, $join_behavior);
	...
	public static function doCountJoinModel(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ReviewPeer::MODEL_ID, ModelPeer::ID, $join_behavior);
	...
	public static function doSelectJoinsfGuardUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Review) to $obj2 (sfGuardUser)
				$obj2->addReview($obj1);
	...
	/**
	 * Selects a collection of Review objects pre-filled with their Model objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Review objects.
	...
	public static function doSelectJoinModel(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Review) to $obj2 (Model)
				$obj2->addReview($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Review) to the collection in $obj2 (sfGuardUser)
				$obj2->addReview($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Review) to the collection in $obj3 (Model)
				$obj3->addReview($obj1);
			} // if joined row not null
	...
	public static function doSelectJoinAllExceptsfGuardUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = ReviewPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Review) to the collection in $obj2 (Model)
				$obj2->addReview($obj1);
	...
	/**
	 * Selects a collection of Review objects pre-filled with all related objects except Model.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	{
		return $withPrefix ? ReviewPeer::CLASS_DEFAULT : ReviewPeer::OM_CLASS;
	}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseReviewPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseReviewPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseReviewPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseReviewPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseReviewPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseReviewPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseReviewPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseReviewPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the review table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseReviewPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
