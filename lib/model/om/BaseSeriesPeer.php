...
/**
 * Base static class for performing query and update operations on the 'series' table.
 *
 * 
 *
...
abstract class BaseSeriesPeer {
	...
	const OM_CLASS = 'Series';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.Series';
	...
	/** the column name for the SERIES_INFO field */
	const SERIES_INFO = 'series.SERIES_INFO';

	/** the column name for the BRAND_ID field */
	const BRAND_ID = 'series.BRAND_ID';

	/** the column name for the WEIGTH field */
	const WEIGTH = 'series.WEIGTH';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'SeriesName', 'SeriesInfo', 'BrandId', 'Weight', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'seriesName', 'seriesInfo', 'brandId', 'weight', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::SERIES_NAME, self::SERIES_INFO, self::BRAND_ID, self::WEIGTH, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'series_name', 'series_info', 'brand_id', 'weigth', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'SeriesName' => 1, 'SeriesInfo' => 2, 'BrandId' => 3, 'Weight' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'seriesName' => 1, 'seriesInfo' => 2, 'brandId' => 3, 'weight' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::SERIES_NAME => 1, self::SERIES_INFO => 2, self::BRAND_ID => 3, self::WEIGTH => 4, self::CREATED_AT => 5, self::UPDATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'series_name' => 1, 'series_info' => 2, 'brand_id' => 3, 'weigth' => 4, 'created_at' => 5, 'updated_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(SeriesPeer::SERIES_NAME);
		$criteria->addSelectColumn(SeriesPeer::SERIES_INFO);
		$criteria->addSelectColumn(SeriesPeer::BRAND_ID);
		$criteria->addSelectColumn(SeriesPeer::WEIGTH);
		$criteria->addSelectColumn(SeriesPeer::CREATED_AT);
		$criteria->addSelectColumn(SeriesPeer::UPDATED_AT);
	}
	 ...
	 *
	 * @param      Series $value A Series object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Series $obj, $key = null)
	{
	...
	/**
	 * Selects a collection of Series objects pre-filled with their Brand objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinBrand(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		SeriesPeer::addSelectColumns($criteria);
		$startcol = (SeriesPeer::NUM_COLUMNS - SeriesPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Series) to $obj2 (Brand)
				$obj2->addSeries($obj1);
	...
	{
		return $withPrefix ? SeriesPeer::CLASS_DEFAULT : SeriesPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Series or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSeriesPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseSeriesPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSeriesPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseSeriesPeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a Series or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSeriesPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseSeriesPeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(SeriesPeer::ID, $criteria->remove(SeriesPeer::ID), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseSeriesPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseSeriesPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the series table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(SeriesPeer::TABLE_NAME, $con);
	...
	/**
	 * Method perform a DELETE on the database, given a Series or Criteria object OR a primary key value.
	 *
	 ...
	 */
	public static function doValidate(Series $obj, $cols = null)
	{
		$columns = array();
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseSeriesPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
