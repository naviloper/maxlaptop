...
abstract class BasesfGuardUser extends BaseObject  implements Persistent {
	...
	/**
	 * @var        array Ads[] Collection to store aggregation of Ads objects.
	 */
	protected $collAdss;

	/**
	 * @var        Criteria The criteria used to select the current contents of collAdss.
	 */
	private $lastAdsCriteria = null;

	/**
	 * @var        array Logs[] Collection to store aggregation of Logs objects.
	 */
	protected $collLogssRelatedByQueryBy;

	/**
	 * @var        Criteria The criteria used to select the current contents of collLogssRelatedByQueryBy.
	 */
	private $lastLogsRelatedByQueryByCriteria = null;

	/**
	 * @var        array Logs[] Collection to store aggregation of Logs objects.
	 */
	protected $collLogssRelatedByCheckBy;

	/**
	 * @var        Criteria The criteria used to select the current contents of collLogssRelatedByCheckBy.
	 */
	private $lastLogsRelatedByCheckByCriteria = null;
	...
	/**
	 * @var        Criteria The criteria used to select the current contents of collShops.
	 */
	private $lastShopCriteria = null;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collAdss = null;
			$this->lastAdsCriteria = null;

			$this->collLogssRelatedByQueryBy = null;
			$this->lastLogsRelatedByQueryByCriteria = null;

			$this->collLogssRelatedByCheckBy = null;
			$this->lastLogsRelatedByCheckByCriteria = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collAdss !== null) {
				foreach ($this->collAdss as $referrerFK) {
			...
			if ($this->collLogssRelatedByQueryBy !== null) {
				foreach ($this->collLogssRelatedByQueryBy as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
			...
			if ($this->collLogssRelatedByCheckBy !== null) {
				foreach ($this->collLogssRelatedByCheckBy as $referrerFK) {
					if (!$referrerFK->isDeleted()) {
						$affectedRows += $referrerFK->save($con);
					}
				}
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getAdss() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addAds($relObj->copy($deepCopy));
				}
			}

			foreach ($this->getLogssRelatedByQueryBy() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addLogsRelatedByQueryBy($relObj->copy($deepCopy));
				}
			}

			foreach ($this->getLogssRelatedByCheckBy() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addLogsRelatedByCheckBy($relObj->copy($deepCopy));
				}
			}
	...
	/**
	 * Clears out the collAdss collection (array).
	 *
	 ...
	 * @see        addAdss()
	 */
	public function clearAdss()
	{
		$this->collAdss = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collAdss collection (array).
	 *
	 * By default this just sets the collAdss collection to an empty array (like clearcollAdss());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initAdss()
	{
		$this->collAdss = array();
	}

	/**
	 * Gets an array of Ads objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related Adss from storage. If this sfGuardUser is new, it will return
	 ...
	 * @throws     PropelException
	 */
	public function getAdss($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collAdss === null) {
			if ($this->isNew()) {
			   $this->collAdss = array();
				...
				AdsPeer::addSelectColumns($criteria);
				$this->collAdss = AdsPeer::doSelect($criteria, $con);
			}
		} else {
	...
	/**
	 * Returns the number of related Ads objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related Ads objects.
	 * @throws     PropelException
	 */
	public function countAdss(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collAdss === null) {
			if ($this->isNew()) {
				...
				$count = AdsPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	/**
	 * Method called to associate a Ads object to this object
	 * through the Ads foreign key attribute.
	 *
	 * @param      Ads $l Ads
	 * @return     void
	 * @throws     PropelException
	 */
	public function addAds(Ads $l)
	{
		if ($this->collAdss === null) {
			$this->initAdss();
		}
		if (!in_array($l, $this->collAdss, true)) { // only add it if the **same** object is not already associated
			array_push($this->collAdss, $l);
	...
	/**
	 * Clears out the collLogssRelatedByQueryBy collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addLogssRelatedByQueryBy()
	 */
	public function clearLogssRelatedByQueryBy()
	{
		$this->collLogssRelatedByQueryBy = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collLogssRelatedByQueryBy collection (array).
	 *
	 * By default this just sets the collLogssRelatedByQueryBy collection to an empty array (like clearcollLogssRelatedByQueryBy());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initLogssRelatedByQueryBy()
	{
		$this->collLogssRelatedByQueryBy = array();
	}

	/**
	 * Gets an array of Logs objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related LogssRelatedByQueryBy from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 ...
	 * @throws     PropelException
	 */
	public function getLogssRelatedByQueryBy($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collLogssRelatedByQueryBy === null) {
			if ($this->isNew()) {
			   $this->collLogssRelatedByQueryBy = array();
				...
				$criteria->add(LogsPeer::QUERY_BY, $this->id);

				LogsPeer::addSelectColumns($criteria);
				$this->collLogssRelatedByQueryBy = LogsPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				LogsPeer::addSelectColumns($criteria);
				if (!isset($this->lastLogsRelatedByQueryByCriteria) || !$this->lastLogsRelatedByQueryByCriteria->equals($criteria)) {
					$this->collLogssRelatedByQueryBy = LogsPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastLogsRelatedByQueryByCriteria = $criteria;
		return $this->collLogssRelatedByQueryBy;
	}

	/**
	 * Returns the number of related Logs objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related Logs objects.
	 * @throws     PropelException
	 */
	public function countLogssRelatedByQueryBy(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collLogssRelatedByQueryBy === null) {
			if ($this->isNew()) {
				...
				$count = LogsPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastLogsRelatedByQueryByCriteria) || !$this->lastLogsRelatedByQueryByCriteria->equals($criteria)) {
					...
					$count = count($this->collLogssRelatedByQueryBy);
				}
			} else {
				$count = count($this->collLogssRelatedByQueryBy);
			}
	...
	/**
	 * Method called to associate a Logs object to this object
	 * through the Logs foreign key attribute.
	 *
	 * @param      Logs $l Logs
	 * @return     void
	 * @throws     PropelException
	 */
	public function addLogsRelatedByQueryBy(Logs $l)
	{
		if ($this->collLogssRelatedByQueryBy === null) {
			$this->initLogssRelatedByQueryBy();
		}
		if (!in_array($l, $this->collLogssRelatedByQueryBy, true)) { // only add it if the **same** object is not already associated
			array_push($this->collLogssRelatedByQueryBy, $l);
			$l->setsfGuardUserRelatedByQueryBy($this);
		}
	}

	/**
	 * Clears out the collLogssRelatedByCheckBy collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addLogssRelatedByCheckBy()
	 */
	public function clearLogssRelatedByCheckBy()
	{
		$this->collLogssRelatedByCheckBy = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collLogssRelatedByCheckBy collection (array).
	 *
	 * By default this just sets the collLogssRelatedByCheckBy collection to an empty array (like clearcollLogssRelatedByCheckBy());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initLogssRelatedByCheckBy()
	{
		$this->collLogssRelatedByCheckBy = array();
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related LogssRelatedByCheckBy from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 ...
	 * @throws     PropelException
	 */
	public function getLogssRelatedByCheckBy($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collLogssRelatedByCheckBy === null) {
			if ($this->isNew()) {
			   $this->collLogssRelatedByCheckBy = array();
				...
				$criteria->add(LogsPeer::CHECK_BY, $this->id);

				LogsPeer::addSelectColumns($criteria);
				$this->collLogssRelatedByCheckBy = LogsPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				LogsPeer::addSelectColumns($criteria);
				if (!isset($this->lastLogsRelatedByCheckByCriteria) || !$this->lastLogsRelatedByCheckByCriteria->equals($criteria)) {
					$this->collLogssRelatedByCheckBy = LogsPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastLogsRelatedByCheckByCriteria = $criteria;
		return $this->collLogssRelatedByCheckBy;
	}
	 ...
	 * @throws     PropelException
	 */
	public function countLogssRelatedByCheckBy(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collLogssRelatedByCheckBy === null) {
			...
			if (!$this->isNew()) {
				...
				if (!isset($this->lastLogsRelatedByCheckByCriteria) || !$this->lastLogsRelatedByCheckByCriteria->equals($criteria)) {
					...
					$count = count($this->collLogssRelatedByCheckBy);
				}
			} else {
				$count = count($this->collLogssRelatedByCheckBy);
			}
	 ...
	 * @throws     PropelException
	 */
	public function addLogsRelatedByCheckBy(Logs $l)
	{
		if ($this->collLogssRelatedByCheckBy === null) {
			$this->initLogssRelatedByCheckBy();
		}
		if (!in_array($l, $this->collLogssRelatedByCheckBy, true)) { // only add it if the **same** object is not already associated
			array_push($this->collLogssRelatedByCheckBy, $l);
			$l->setsfGuardUserRelatedByCheckBy($this);
		}
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related Reviews from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collReviews === null) {
			if ($this->isNew()) {
			   $this->collReviews = array();
				...
				$criteria->add(ReviewPeer::AUTHOR_ID, $this->id);
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getReviewsJoinModel($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collReviews === null) {
			if ($this->isNew()) {
				...
				$this->collReviews = ReviewPeer::doSelectJoinModel($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related Scores from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collScores === null) {
			if ($this->isNew()) {
			   $this->collScores = array();
				...
				$criteria->add(ScorePeer::USER_ID, $this->id);
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getScoresJoinModel($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collScores === null) {
			if ($this->isNew()) {
				...
				$this->collScores = ScorePeer::doSelectJoinModel($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	/**
	 * Clears out the collShops collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	...
	/**
	 * Initializes the collShops collection (array).
	 *
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related Shops from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collShops === null) {
			if ($this->isNew()) {
			   $this->collShops = array();
				...
				$criteria->add(ShopPeer::OWNER_ID, $this->id);

				ShopPeer::addSelectColumns($criteria);
				$this->collShops = ShopPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				ShopPeer::addSelectColumns($criteria);
				if (!isset($this->lastShopCriteria) || !$this->lastShopCriteria->equals($criteria)) {
					$this->collShops = ShopPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastShopCriteria = $criteria;
	...
	public function countShops(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collShops === null) {
			if ($this->isNew()) {
				...
				$count = ShopPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
	...
	public function addShop(Shop $l)
	{
		...
		if (!in_array($l, $this->collShops, true)) { // only add it if the **same** object is not already associated
			array_push($this->collShops, $l);
			$l->setsfGuardUser($this);
		}
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfGuardUser has previously been saved, it will retrieve
	 * related UserMetas from storage. If this sfGuardUser is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collUserMetas === null) {
			if ($this->isNew()) {
			   $this->collUserMetas = array();
				...
				$criteria->add(UserMetaPeer::USER_ID, $this->id);
	 ...
	 * actually need in sfGuardUser.
	 */
	public function getUserMetasJoinModel($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfGuardUserPeer::DATABASE_NAME);
		}
		...
		if ($this->collUserMetas === null) {
			if ($this->isNew()) {
				...
				$this->collUserMetas = UserMetaPeer::doSelectJoinModel($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			if ($this->collAdss) {
				foreach ((array) $this->collAdss as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collLogssRelatedByQueryBy) {
				foreach ((array) $this->collLogssRelatedByQueryBy as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collLogssRelatedByCheckBy) {
				foreach ((array) $this->collLogssRelatedByCheckBy as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collReviews) {
			...
			if ($this->collShops) {
				foreach ((array) $this->collShops as $o) {
					$o->clearAllReferences($deep);
				}
			}
