...
abstract class BasePostPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Keywords', 'Metadata', 'Content', 'IsPublished', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'keywords', 'metadata', 'content', 'isPublished', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TITLE, self::KEYWORDS, self::METADATA, self::CONTENT, self::IS_PUBLISHED, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'keywords', 'metadata', 'content', 'is_published', 'created_at', 'updated_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Keywords' => 2, 'Metadata' => 3, 'Content' => 4, 'IsPublished' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'keywords' => 2, 'metadata' => 3, 'content' => 4, 'isPublished' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TITLE => 1, self::KEYWORDS => 2, self::METADATA => 3, self::CONTENT => 4, self::IS_PUBLISHED => 5, self::CREATED_AT => 6, self::UPDATED_AT => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'keywords' => 2, 'metadata' => 3, 'content' => 4, 'is_published' => 5, 'created_at' => 6, 'updated_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PostPeer::KEYWORDS);
		$criteria->addSelectColumn(PostPeer::METADATA);
